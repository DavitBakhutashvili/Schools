...
function PupilStateContextProvider(props) {
    ...
    const value={pupils,setPupils,modalOpen,setModalOpen,searchPupilValues,
      setSearchPupilValues,pupilValues,setPupilValues,
       handlerChange, OpenModal,CloseModal,currentSchoolId, setCurrentSchoolId}
